...
<head>
    ...
    <meta name="keywords" content="kindlemate">
    <meta name="description" content="kindlemate 博客后台">
    <!--[if lt IE 9]>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle img-responsive" style="width:64px;height:64px;overflow: hidden" src="/images/gravatar.jpg" /></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="{{url('/admin/picture/tree')}}">上传</a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="" data-index="0">系统设置</a>
                        </li>
                    </ul>
                </li>
